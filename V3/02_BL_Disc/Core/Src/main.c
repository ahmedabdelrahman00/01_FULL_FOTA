...
char page_command[] = "page page2"; // or "page Temp"
uint8_t end_command[] = {0xFF, 0xFF, 0xFF};
...
//  HAL_UART_Transmit(&huart3, (uint8_t*)page_command, strlen(page_command), HAL_MAX_DELAY);

  // Transmit end command
